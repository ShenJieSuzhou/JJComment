...
//    commentLabel.textColor = MHGlobalGrayTextColor;
    ...
    commentLabel.font = JJFont(JJPxConvertPt(11.0f), NO);
//    commentLabel.textColor = MHGlobalGrayTextColor;
    ...
    textView.font = JJFont(JJPxConvertPt(13.0f), NO);
    ...
    textView.layer.cornerRadius = JJPxConvertPt(5.0f);
    textView.layer.borderWidth = JJPxConvertPt(1.0f);
//    textView.layer.borderColor = JJColorFroJJexString(@"#FB9A4B").CGColor;
//    textView.backgroundColor = JJColorFroJJexString(@"#F5F5F5");
    ...
    attributedText.yy_font = JJFont(JJPxConvertPt(9.0f), NO);
...
- (void)_textViewWordsDidChange:(YYTextView *)textView
{
    ...
    UIFont *font = JJFont(JJPxConvertPt(9.0f), NO);
    UIColor *color = textView.attributedText.length<=300 ? [UIColor blackColor] : [UIColor redColor];
